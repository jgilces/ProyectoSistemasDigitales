...
-- *****************************************************************************
-- Generated on "01/15/2018 00:46:01"
                                                             
-- Vhdl Test Bench(with test vectors) for design  :          prueba_sost
-- 
...
ENTITY prueba_sost_vhd_vec_tst IS
END prueba_sost_vhd_vec_tst;
ARCHITECTURE prueba_sost_arch OF prueba_sost_vhd_vec_tst IS
-- constants                                                 
-- signals                                                   
